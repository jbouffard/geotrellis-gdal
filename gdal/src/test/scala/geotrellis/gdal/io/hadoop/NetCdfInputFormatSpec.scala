...
class NetCdfInputFormatSpec extends FunSpec with Matchers {
  ...
  describe("Type and Date reader") {
    ...
    val DateTime19500101 = ZonedDateTime.of(1950, 1, 1, 0, 0, 0, 0, ZoneOffset.UTC)
    ...
    it("should read input with date with offsets") {
      ...
      typ should be ("days")
      date should be (ZonedDateTime.of(1955, 4, 4, 0, 0, 0, 0, ZoneOffset.UTC))
    }
    ...
    it("should read input with other formatting") {
      ...
      typ should be ("days")
      date should be (ZonedDateTime.of(1971, 3, 3, 0, 0, 0, 0, ZoneOffset.UTC))
    }
    ...
    it("should read input with hours included") {
      ...
      typ should be ("days")
      date should be (ZonedDateTime.of(1971, 3, 3, 23, 0, 0, 0, ZoneOffset.UTC))
    }
    ...
    it("should read input with minutes included") {
      ...
      typ should be ("days")
      date should be (ZonedDateTime.of(1971, 3, 3, 0, 23, 0, 0, ZoneOffset.UTC))
    }
    ...
    it("should read input with seconds included") {
      ...
      typ should be ("days")
      date should be (ZonedDateTime.of(1971, 3, 3, 0, 0, 23, 0, ZoneOffset.UTC))
    }
